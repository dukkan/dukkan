...
namespace Dukkan.MultiTenancy.Services
{
    ...
    public class TenantAppService : AsyncCrudAppService<Tenant, TenantDto, int, TenantGetAllPagedInput, TenantCreateDto, TenantDto>, ITenantAppService
    {
        ...
        protected override IQueryable<Tenant> CreateFilteredQuery(TenantGetAllPagedInput input)
        {
