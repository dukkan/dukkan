...
namespace Dukkan.Authorization.Users.Services
{
    ...
    public class UserAppService : AsyncCrudAppService<User, UserDto, long, UserGetAllPagedInput, UserCreateDto, UserDto>, IUserAppService
    {
        ...
        protected override IQueryable<User> CreateFilteredQuery(UserGetAllPagedInput input)
        {
        ...
        protected override IQueryable<User> ApplySorting(IQueryable<User> query, UserGetAllPagedInput input)
        {
        ...
        public async Task<bool> ChangePassword(UserChangePasswordDto input)
        {
            ...
            if (!new Regex(User.PasswordRegex).IsMatch(input.NewPassword))
            {
