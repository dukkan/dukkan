...
{
    [DbContext(typeof(DukkanZeroDbContext))]
    partial class DukkanZeroDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dukkan.Authorization.Roles.Domain.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Dukkan.Authorization.Users.Domain.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Dukkan.MultiTenancy.Domain.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Dukkan.Authorization.Roles.Domain.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Dukkan.Authorization.Users.Domain.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Dukkan.Authorization.Roles.Domain.Role", b =>
                {
                    b.HasOne("Dukkan.Authorization.Users.Domain.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("Dukkan.Authorization.Users.Domain.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("Dukkan.Authorization.Users.Domain.User", "LastModifierUser")
                        .WithMany()
