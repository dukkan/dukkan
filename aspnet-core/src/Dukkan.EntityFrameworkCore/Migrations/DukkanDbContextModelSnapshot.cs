...
namespace Dukkan.Migrations
{
    ...
    partial class DukkanDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dukkan.Catalog.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Dukkan.Catalog.CategoryTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Dukkan.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Dukkan.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Dukkan.Catalog.CategoryTranslation", b =>
                {
                    b.HasOne("Dukkan.Catalog.Category", "Core")
